...
rpm = [500, 1000, 1500, 2000, 2500, 3000, 3500,
...
fu = interp2d(load, rpm, afr, kind='linear', fill_value='-1')
y = float(round(fu(100, 2000)[0], 4))
print(y)
...
R = 8.3143
T = float(input("Input Tempreature"))
n = 4
F = 96480
Po_air = float(input("Partial Pressure"))
Po_exh = float(input("Partial Pressure of Exhaust Gas"))


output_using_sensor = ((R*T)/(n*F)) * (np.log(Po_air/Po_exh))
print(output_using_sensor)
